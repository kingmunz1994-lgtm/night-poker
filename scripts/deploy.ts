/**
 * deploy.ts — Deploy poker to Midnight Preprod
 *
 * Run:
...
const ZK_CONFIG_PATH = path.resolve(import.meta.dirname, '..', 'contracts', 'managed', 'night-poker');
...
async function main() {
  ...
  console.log('\n🚀 Deploying poker to Midnight Preprod...\n');
  ...
  const deployed = await deployContract(providers, { compiledContract: compiled, privateStateId: 'nightPokerState', initialPrivateState: {} });
